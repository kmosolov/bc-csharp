...
namespace Org.BouncyCastle.Cms
{
    internal class CmsSignedHelper
    {
		...
		static CmsSignedHelper()
		{
			...
			encryptionAlgs.Add(KNCAObjectIdentifiers.Gost34310x2004.Id, "ECGOST3410");
			encryptionAlgs.Add(KNCAObjectIdentifiers.Gost34311x95WithGost34310x2004.Id, "ECGOST3410");
			...
			digestAlgs.Add(KNCAObjectIdentifiers.Gost34311x95.Id,  "GOST3411");
